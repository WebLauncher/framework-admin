...
$parts=explode('/',$url);
array_pop($parts);array_pop($parts);array_pop($parts);array_pop($parts);array_pop($parts);array_pop($parts);array_pop($parts);
$baseUrl = implode('/',$parts).'/files/userfiles/';
...
$curpath=$info['dirname'];
$info=pathinfo($curpath);
$curpath=$info['dirname'];
$info=pathinfo($curpath);
$curpath=$info['dirname'];
$baseDir = $curpath.'/files/userfiles/';
